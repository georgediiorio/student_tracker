...
$notesquery = "SELECT * FROM NOTES WHERE user_id = $this_user_id";
...
echo "<p class='user'>Birthday: " . $row['birthday'] . "</p>";
...
echo "<h1 class='user-name user'>Faculty Notes </h1>";  
 ...
 echo "<tr><td class='center'>" . $row2['Faculty_id'] . "</td><td>" . $row2['course_name'] . "</td>
